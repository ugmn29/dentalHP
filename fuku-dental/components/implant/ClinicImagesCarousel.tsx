...
const clinicImages = [
  {
    imageId: 'clinic1',
    alt: 'Fデンタルオフィス 豊洲プライムスクエア院 診療室の内観', // 医院の実写真に差し替え予定
  },
  {
    imageId: 'clinic2',
    alt: 'Fデンタルオフィス 豊洲プライムスクエア院 CT機器の外観', // 医院の実写真に差し替え予定
  },
  {
    imageId: 'clinic3',
    alt: 'Fデンタルオフィス 豊洲プライムスクエア院 滅菌室・衛生管理設備', // 医院の実写真に差し替え予定
  },
  {
    imageId: 'clinic4',
    alt: 'Fデンタルオフィス 豊洲プライムスクエア院 オペ室の内観', // 医院の実写真に差し替え予定
  },
];
