...
export const metadata: Metadata = {
  ...
  description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院が小児矯正で使用する装置を一覧でご紹介。プレオルソ・拡大床・ワイヤー矯正など、各装置の特徴・対象年齢・治療期間を比較。お子様に最適な装置をご提案します。',
  keywords: '小児矯正 装置,子供 矯正 種類,プレオルソ,拡大床,小児矯正 装置 比較,豊洲 小児矯正',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/appliances',
  },
  openGraph: {
    title: '小児矯正の装置一覧｜種類と特徴を比較｜Fデンタルオフィス 豊洲プライムスクエア院',
