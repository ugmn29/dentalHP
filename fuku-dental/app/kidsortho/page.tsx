                            ...
                            {features.map((feature, index) => (
                                <div key={feature.id} className="flex flex-col group">
                                    ...
                                    <div className="relative h-24 flex items-center mb-0">
                                        ...
                                        <span
                                            className={`absolute top-[20%] -translate-y-1/2 block text-[8rem] md:text-[11rem] leading-[0.8] font-serif text-transparent bg-clip-text bg-gradient-to-b from-[#FF9B5A] via-[#FFB380] to-transparent select-none opacity-60 scale-x-[0.85] tracking-tighter ${index % 2 === 0 ? 'left-[-1rem] origin-left' : 'right-0 origin-right'}`}
                                        >
                                            {feature.id}
                                        </span>
