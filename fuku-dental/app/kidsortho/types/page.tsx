...
export const metadata: Metadata = {
  ...
  description: '子供の不正咬合の種類を歯科医師が解説。出っ歯・受け口・すきっ歯・叢生・開咬・過蓋咬合・交叉咬合など、各タイプの特徴と治療法をわかりやすくご紹介。豊洲のFデンタルオフィス 豊洲プライムスクエア院で無料相談。',
  keywords: '不正咬合 種類,子供 歯並び 種類,出っ歯,受け口,すきっ歯,叢生,開咬,過蓋咬合,豊洲 小児矯正',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types',
  },
  openGraph: {
    title: '子供の不正咬合の種類｜歯並びタイプ別解説｜Fデンタルオフィス 豊洲プライムスクエア院',
