                ...
                <section className="pt-8 pb-2 bg-[#FDFBF7]">
                    <div className="container mx-auto px-4 max-w-5xl">
                        ...
                        <div className="mb-20">
                            ...
                            <div className="space-y-4 text-[#5A4D41] leading-loose max-w-3xl mx-auto mb-8">
                                <p>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                                    ...
                                    <h3 className="font-bold text-[#5A4D41] mb-2">見た目への影響</h3>
                                ...
                                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                                    ...
                                    <h3 className="font-bold text-[#5A4D41] mb-2">機能への影響</h3>
                                    <p className="text-sm text-[#8D8070]">
                                ...
                                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                                    ...
                                    <h3 className="font-bold text-[#5A4D41] mb-2">健康への影響</h3>
                                    <p className="text-sm text-[#8D8070]">
                        ...
                        <div className="mb-16">
                            <div className="text-center mb-8">
                                <h2 className="text-3xl md:text-4xl font-bold text-[#5A4D41] font-serif inline-block">主な不正咬合の種類</h2>
                                <div className="w-16 h-0.5 bg-[#E67A2E] mx-auto mt-4"></div>
                            </div>
                            ...
                            <div className="space-y-12">
                                {/* 1. 上顎前突（出っ歯） */}
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">1</span>
                                        上顎前突（じょうがくぜんとつ）
                                    </h3>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            <h4 className="font-bold mb-2">主な原因</h4>
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">遺伝的要因：</strong>顎の骨格が遺伝</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">悪習癖：</strong>指しゃぶり、舌で前歯を押す癖</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="bg-white p-4 rounded-xl border border-[#E67A2E]/10">
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">2</span>
                                        下顎前突（かがくぜんとつ）
                                    </h3>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">遺伝的要因：</strong>下顎の過成長、上顎の劣成長</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">悪習癖：</strong>舌の位置が低い、口呼吸</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">3</span>
                                        叢生（そうせい）
                                    </h3>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">顎の発育不足：</strong>歯が並ぶスペースが足りない</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">歯のサイズ：</strong>歯が大きく顎が小さい</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">4</span>
                                        開咬（かいこう）
                                    </h3>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">悪習癖：</strong>指しゃぶり、舌を出す癖</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">口呼吸：</strong>常に口が開いている</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">5</span>
                                        過蓋咬合（かがいこうごう）
                                    </h3>
                                    <p className="text-lg text-[#E67A2E] font-bold mb-4">通称：ディープバイト</p>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">骨格的要因：</strong>上顎が下顎より大きい</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">歯の萌出異常：</strong>奥歯の萌出不足</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">6</span>
                                        交叉咬合（こうさこうごう）
                                    </h3>
                                    ...
                                    <div className="space-y-4 text-[#5A4D41] leading-loose">
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                                                    <p className="text-sm"><strong className="text-red-700">上顎の幅が狭い：</strong>顎の成長不足</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">悪習癖：</strong>片側だけで噛む癖</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-4 pb-2 border-b-2 border-[#E67A2E] flex items-center gap-3">
                                        <span className="w-10 h-10 bg-[#E67A2E] rounded-full flex items-center justify-center text-white text-lg font-bold flex-shrink-0">7</span>
                                        空隙歯列（くうげきしれつ）
                                    </h3>
                                        ...
                                        <div>
                                            ...
                                            <div className="grid md:grid-cols-2 gap-4">
                                                <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                                                    <p className="text-sm"><strong className="text-blue-700">顎が大きい：</strong>歯のサイズに対して顎が大きい</p>
                                                </div>
                                                <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                                                    <p className="text-sm"><strong className="text-yellow-700">悪習癖：</strong>舌で前歯を押す癖</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div className="mb-16">
                            <div className="text-center mb-8">
                                <h2 className="text-3xl md:text-4xl font-bold text-[#5A4D41] font-serif inline-block">複数のタイプが併発することも</h2>
                                <div className="w-16 h-0.5 bg-[#E67A2E] mx-auto mt-4"></div>
                            </div>
                            ...
                            <div className="space-y-4 text-[#5A4D41] leading-loose max-w-3xl mx-auto">
                                ...
                                <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                                    <p className="text-sm">
                                        <strong className="text-[#E67A2E]">重要：</strong>複数の不正咬合が組み合わさっている場合、治療の優先順位や方法が変わります。精密検査を行い、お子さま一人ひとりに最適な治療計画を立てることが重要です。
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] text-lg">どのタイプの不正咬合が最も治療が必要ですか？</h3>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] text-lg">複数のタイプが混在している場合、どうすればいいですか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] text-lg">自宅でチェックできる方法はありますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                        ...
                                        <div className="bg-blue-50 p-6 rounded-xl mb-3">
                                            <h4 className="font-bold text-blue-700 mb-3">セルフチェックリスト</h4>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] text-lg">不正咬合は遺伝しますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4 mb-3">
                                            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                                                <p className="font-bold text-red-700 mb-2">遺伝的要因（約30〜40%）</p>
                                            ...
                                            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                                <p className="font-bold text-blue-700 mb-2">環境的要因（約60〜70%）</p>
                                                <ul className="text-sm text-[#5A4D41] space-y-1">
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] text-lg">いつ歯科医院を受診すべきですか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
