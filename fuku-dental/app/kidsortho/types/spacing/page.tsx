...
export const metadata: Metadata = {
  ...
  keywords: '空隙歯列,歯間,隙間,歯の隙間,こども矯正,小児矯正,歯列矯正,不正咬合,豊洲,江東区',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types/spacing',
  },
  openGraph: {
    title: '空隙歯列（くうげきしれつ）の治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
              ...
              <div className="mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-[#8D8070] leading-loose">
                  ...
                  <div>
                    ...
                    <p className="text-sm">¥132,000〜¥495,000<br /><span className="text-xs">（装置により異なります）</span></p>
                  </div>
                </div>
              </div>
