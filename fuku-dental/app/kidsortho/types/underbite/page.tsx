...
export const metadata: Metadata = {
  title: '下顎前突（受け口）の治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
  description: '下顎前突（受け口）の特徴、原因、治療法について詳しく解説。早期治療で効果的に改善できる不正咬合の一つです。お子様の歯並びが気になる方はご相談ください。',
  keywords: '下顎前突,受け口,反対咬合,こども矯正,小児矯正,歯列矯正,不正咬合,豊洲,江東区',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types/underbite',
  },
  openGraph: {
    title: '下顎前突（受け口）の治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-6">
                ...
                <PageImage path="/kidsortho/types/underbite" imageId="受け口の横顔と歯列図" alt="下顎前突（受け口）の治療" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
        ...
        <div className="container mx-auto px-4 py-2 pb-16">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <RelatedPagesSection
              ...
              currentPath="/kidsortho/types/underbite"
            />
          </div>
        </div>
