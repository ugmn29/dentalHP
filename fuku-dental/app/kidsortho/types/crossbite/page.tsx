...
export const metadata: Metadata = {
  title: '交叉咬合（こうさこうごう）クロスバイトの治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
  description: '交叉咬合（クロスバイト）の特徴、原因、治療法について詳しく解説。上下の歯が交差して噛み合う状態で、顔の歪みを引き起こす可能性があります。お子様の歯並びが気になる方はご相談ください。',
  keywords: '交叉咬合,クロスバイト,歯の交差,顔の歪み,こども矯正,小児矯正,歯列矯正,不正咬合,豊洲,江東区',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types/crossbite',
  },
  openGraph: {
    title: '交叉咬合（こうさこうごう）クロスバイトの治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <PageImage path="/kidsortho/types/crossbite" imageId="交叉咬合の正面歯列図" alt="交叉咬合（クロスバイト）の治療" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
      ...
      <div className="container mx-auto px-4 py-2 md:py-2">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <RelatedPagesSection
            ...
            currentPath="/kidsortho/types/crossbite"
          />
        </div>
      </div>
                {/* 監修者情報 */}
