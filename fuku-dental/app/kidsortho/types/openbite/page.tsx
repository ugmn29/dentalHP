...
export const metadata: Metadata = {
  ...
  keywords: '開咬,オープンバイト,前歯が閉じない,こども矯正,小児矯正,歯列矯正,不正咬合,豊洲,江東区',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types/openbite',
  },
  openGraph: {
    title: '開咬（かいこう）オープンバイトの治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <PageImage path="/kidsortho/types/openbite" imageId="開咬の正面歯列図" alt="開咬（オープンバイト）の治療" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
      ...
      <div className="container mx-auto px-4 py-2 md:py-2">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <RelatedPagesSection
            ...
            currentPath="/kidsortho/types/openbite"
          />
        </div>
      </div>
                {/* 監修者情報 */}
