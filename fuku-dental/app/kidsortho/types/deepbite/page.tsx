...
export const metadata: Metadata = {
  title: '過蓋咬合（かがいこうごう）ディープバイトの治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
  description: '過蓋咬合（ディープバイト）の特徴、原因、治療法について詳しく解説。上の前歯が下の前歯を深く覆う状態で、早期治療が効果的です。お子様の歯並びが気になる方はご相談ください。',
  keywords: '過蓋咬合,ディープバイト,深い噛み合わせ,こども矯正,小児矯正,歯列矯正,不正咬合,豊洲,江東区',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/types/deepbite',
  },
  openGraph: {
    title: '過蓋咬合（かがいこうごう）ディープバイトの治療 | こども矯正 | Fデンタルオフィス 豊洲プライムスクエア院',
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <PageImage path="/kidsortho/types/deepbite" imageId="過蓋咬合の横顔と噛み合わせ断面図" alt="過蓋咬合（ディープバイト）の治療" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
      ...
      <div className="container mx-auto px-4 py-2 md:py-2">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <RelatedPagesSection
            ...
            currentPath="/kidsortho/types/deepbite"
          />
        </div>
      </div>
                {/* 監修者情報 */}
