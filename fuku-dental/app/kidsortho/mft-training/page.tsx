...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://fshika.com/kidsortho/mft-training',
  },
  openGraph: {
    title: '自宅でできるMFT｜あいうべ体操とボタンプル完全ガイド｜Fデンタルオフィス 豊洲プライムスクエア院',
        ...
        <section className="py-6 md:py-6 bg-[#FDFBF7]">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <PageImage path="/kidsortho/mft-training" imageId="あいうべ体操4ステップの口の形" alt="MFTトレーニング あいうべ体操とボタンプル" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
