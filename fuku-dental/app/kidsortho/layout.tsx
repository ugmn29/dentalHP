...
export const metadata: Metadata = {
  title: '豊洲の小児矯正｜子供の歯並び治療｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院で小児矯正。お子様の成長を利用した負担の少ない矯正治療で、将来の歯並びを整えます。出っ歯・受け口・すきっ歯など各症例に対応。無料相談実施中。',
