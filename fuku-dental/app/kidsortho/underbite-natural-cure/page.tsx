        ...
        <div className="bg-[#FDFBF7] border-b">
          <div className="container mx-auto px-4 py-3">
            <div className="flex items-center text-sm text-[#8D8070]">
              ...
              <ChevronRight className="w-4 h-4 mx-2" />
              <span className="text-[#C5A572] font-bold">受け口は自然に治る？</span>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="text-center mb-20">
              ...
              <div className="space-y-4 text-[#5A4D41] leading-loose max-w-3xl mx-auto">
                ...
                <p>
                  <span className="text-[#C5A572] font-bold">3歳からの早期治療（ムーシールド・プレオルソ）</span>なら、
                  成功率85%以上で改善が可能です。
                </p>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* 骨格型反対咬合 */}
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border-2 border-red-200">
                  <h4 className="text-xl md:text-2xl font-bold text-red-600 mb-6 text-center pb-3 border-b-2 border-red-200">
                    骨格型反対咬合
                  </h4>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="font-bold text-[#5A4D41] text-sm">原因</p>
                      </div>
                      <p className="text-[#5A4D41] text-sm md:text-base pl-4">
                        下顎の骨が前方に成長しすぎ
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-2 h-2 bg-red-600 rounded-full"></span>
                        <p className="font-bold text-[#5A4D41] text-sm">自然治癒</p>
                      </div>
                      <p className="text-red-600 font-bold text-base md:text-lg pl-4">
                        ほぼ不可能（0〜5%）
                      </p>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-2 h-2 bg-red-600 rounded-full"></span>
                        <p className="font-bold text-[#5A4D41] text-sm">治療開始時期</p>
                      </div>
                      <div className="pl-4">
                        <p className="text-[#C5A572] font-bold text-lg md:text-xl">3〜5歳</p>
                        <p className="text-xs md:text-sm text-gray-600 mt-1">（早ければ早いほど良い）</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-red-50 p-4 rounded-xl">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="w-2 h-2 bg-red-600 rounded-full"></span>
                        <p className="font-bold text-[#5A4D41] text-sm">放置した場合</p>
                      </div>
                      <p className="text-red-600 font-bold text-sm md:text-base pl-4">
                        外科的矯正（手術）が必要
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border-2 border-green-200">
                  <h4 className="text-xl md:text-2xl font-bold text-green-600 mb-6 text-center pb-3 border-b-2 border-green-200">
                    機能性反対咬合
                  </h4>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-green-600 font-bold text-base md:text-lg pl-4">
                        可能性あり（14%）
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="pl-4">
                        <p className="text-[#C5A572] font-bold text-lg md:text-xl">6歳前後</p>
                        <p className="text-xs md:text-sm text-gray-600 mt-1">（永久歯萌出後）</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-orange-50 p-4 rounded-xl">
                      ...
                      <p className="text-orange-600 font-bold text-sm md:text-base pl-4">
                        骨格型に移行する可能性
                      </p>
                    </div>
                  </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-md border-2 border-[#C5A572]/20">
                  <h4 className="text-xl font-bold text-[#C5A572] mb-4">ムーシールド</h4>
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <p className="text-sm text-gray-700">成功率<span className="font-bold text-[#C5A572]">85%以上</span></p>
                    </div>
                  </div>
                ...
                {/* プレオルソ */}
                <div className="bg-white p-8 rounded-2xl shadow-md border-2 border-[#C5A572]/20">
                  <h4 className="text-xl font-bold text-[#C5A572] mb-4">プレオルソ</h4>
                  <div className="space-y-3 mb-6">
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                  ...
                  <div className="text-[#8D8070] leading-relaxed">
                    <p className="mb-3">
                      <strong className="text-[#C5A572]">A.</strong> レントゲン検査で判断できます。機能性反対咬合（歯の傾斜のみ）であれば自然治癒の可能性がありますが、
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                  ...
                  <div className="text-[#8D8070] leading-relaxed">
                    <p>
                      <strong className="text-[#C5A572]">A.</strong> むしろ<span className="font-bold bg-yellow-100">3歳がベストタイミング</span>です。
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                  ...
                  <div className="text-[#8D8070] leading-relaxed">
                    <p>
                      <strong className="text-[#C5A572]">A.</strong> ムーシールドは<span className="font-bold bg-yellow-100">就寝時のみの装着</span>なので、
