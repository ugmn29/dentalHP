...
import { ChevronRight, BookOpen, AlertCircle, CheckCircle2, Trophy, Music, HeartPulse, Wind } from 'lucide-react'

export const metadata: Metadata = {
  title: 'スポーツ・楽器への影響｜歯並びと運動・演奏パフォーマンスの関係｜F歯科・矯正歯科',
      ...
      <div className="bg-[#FDFBF7] py-4">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="flex items-center gap-2 text-sm">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-[#E67A2E]">スポーツ・楽器への影響</span>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-gradient-to-br from-[#FDFBF7] to-white rounded-3xl shadow-xl p-8 md:p-12 border-2 border-[#E67A2E]/20">
            ...
            <div className="prose prose-lg max-w-none text-[#5A4D41] leading-loose">
              ...
              <p className="mb-4">
                特に<span className="font-bold text-[#E67A2E]">「食いしばり」「呼吸」「口腔容積」</span>の3つが重要で、
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border-2 border-[#E67A2E]/20 mb-8">
            <div className="space-y-8">
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">食いしばりができず、瞬発力が出ない</h4>
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    <p className="text-xs text-gray-700 mb-2">
                      <span className="font-bold text-[#E67A2E]">影響が大きいスポーツ：</span>
                    </p>
                    <ul className="text-xs text-gray-700 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span>陸上（短距離・跳躍）、サッカー、バスケットボール、野球、テニスなど</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">口呼吸で持久力が低下する</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    ...
                    <ul className="text-xs text-gray-700 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span>陸上（長距離）、水泳、サッカー、バスケットボール、自転車など</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">顎の位置がずれて、バランス感覚が悪化</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    ...
                    <ul className="text-xs text-gray-700 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span>体操、フィギュアスケート、ダンス、サーフィン、スケートボードなど</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">集中力が低下し、反応速度が遅くなる</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    ...
                    <ul className="text-xs text-gray-700 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span>卓球、バドミントン、テニス、野球（バッティング）、格闘技など</span>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="bg-gradient-to-br from-[#FDFBF7] to-white rounded-3xl shadow-xl p-8 md:p-10 border-2 border-[#E67A2E]/20 mb-8">
            <div className="space-y-8">
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">管楽器：息が漏れて音が出ない</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    <p className="text-xs text-gray-700 mb-2">
                      <span className="font-bold text-[#E67A2E]">影響が大きい楽器：</span>
                    </p>
                    <ul className="text-xs text-gray-700 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span><span className="font-bold">金管楽器</span>：トランペット、ホルン、トロンボーン、チューバ</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-[#E67A2E] mt-1">●</span>
                        <span><span className="font-bold">木管楽器</span>：フルート、クラリネット、オーボエ、サックス</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">口腔容積が狭く、息のコントロールが難しい</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    <p className="text-xs text-gray-700">
                      <span className="font-bold text-[#E67A2E]">特に影響するのは：</span>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">舌が正しい位置に置けず、タンギングができない</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
                  ...
                  <div className="bg-[#FDFBF7] p-4 rounded-lg">
                    <p className="text-xs text-gray-700">
                      <span className="font-bold text-[#E67A2E]">影響：</span>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl border-2 border-[#E67A2E]/20">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-[#E67A2E] mb-2 text-lg">長時間の練習で顎が疲れやすい</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-3">
          ...
          <div className="bg-gradient-to-br from-[#E67A2E]/10 to-[#E67A2E]/5 rounded-3xl p-8 border-2 border-[#E67A2E]/20">
            <div className="flex items-start gap-4">
              <Music className="w-10 h-10 text-[#E67A2E] flex-shrink-0 mt-1" />
              <div className="flex-1">
                ...
                <p className="text-gray-700 leading-loose mb-3">
                  ...
                  <span className="font-bold text-[#E67A2E]">子どもの頃から矯正治療を受けることが推奨</span>されています。
                </p>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-sm text-gray-700">
                    <span className="font-bold text-[#E67A2E]">注意：</span>
      ...
      <section className="py-2 bg-[#FDFBF7]">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#E67A2E]/20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-green-700 mb-2 text-lg">正しく食いしばれるようになる</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-2">
                    矯正治療で咬合（噛み合わせ）が整うと、<span className="font-bold bg-yellow-100">上下の歯がしっかり噛み合い、食いしばりができる</span>ようになります。
                    食いしばることで全身に力が入り、<span className="font-bold text-green-700">瞬発力が20〜30%向上</span>します。
                  </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#E67A2E]/20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-green-700 mb-2 text-lg">鼻呼吸ができるようになる</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-2">
                    歯並びが整うと、<span className="font-bold bg-yellow-100">舌が正しい位置（上顎）に置けるようになり、口が閉じやすくなります</span>。
                    口呼吸から鼻呼吸に切り替わることで、<span className="font-bold text-green-700">酸素摂取効率が30%向上</span>します。
                  </p>
                  <div className="bg-[#FDFBF7] p-3 rounded-lg">
                    <p className="text-xs text-gray-700">
                      <span className="font-bold text-green-700">効果：</span>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#E67A2E]/20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-green-700 mb-2 text-lg">全身のバランスが改善される</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-2">
                    咬合が正しくなると、<span className="font-bold bg-yellow-100">頭の位置が正常に戻り、全身のバランスが整います</span>。
                    体幹が安定し、<span className="font-bold text-green-700">バランス感覚が向上</span>します。
                  </p>
                  <div className="bg-[#FDFBF7] p-3 rounded-lg">
                    <p className="text-xs text-gray-700">
                      <span className="font-bold text-green-700">効果：</span>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#E67A2E]/20">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="font-bold text-green-700 mb-2 text-lg">口腔容積が広がり、息のコントロールが向上</h4>
                  <p className="text-sm text-gray-700 leading-relaxed mb-2">
                    矯正治療で顎が広がると、<span className="font-bold bg-yellow-100">口の中のスペースが広くなり、舌が自由に動かせる</span>ようになります。
                    管楽器の演奏で、<span className="font-bold text-green-700">息の量・速さを正確にコントロール</span>できるようになります。
                  </p>
                  <div className="bg-[#FDFBF7] p-3 rounded-lg">
                    <p className="text-xs text-gray-700">
                      <span className="font-bold text-green-700">効果：</span>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    大会や発表会の直前は避け、<span className="font-bold text-[#E67A2E]">少なくとも3ヶ月前</span>には治療を開始しましょう。
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    スポーツや楽器の練習中は外せるため、<span className="font-bold text-[#E67A2E]">パフォーマンスへの影響が少ない</span>です。
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    最初は<span className="font-bold text-[#E67A2E]">短時間の練習から始めて、徐々に装置に慣らす</span>ことが重要です。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-[#E67A2E]/10">
              <h3 className="text-xl font-bold text-[#E67A2E] mb-4 flex items-start gap-3">
                ...
                <span>矯正治療中でもスポーツはできますか？</span>
              </h3>
              <div className="pl-9">
                <p className="text-gray-700 leading-loose">
                  <span className="font-bold text-[#5A4D41]">A.</span>
                  はい、<span className="font-bold bg-yellow-100">矯正治療中でもスポーツは可能</span>です。
                  取り外し式の装置（プレオルソ・ムーシールド）なら、練習中は外せます。
                  固定式のワイヤー矯正の場合、<span className="font-bold text-[#E67A2E]">マウスガードを装着</span>することで、
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-[#E67A2E]/10">
              <h3 className="text-xl font-bold text-[#E67A2E] mb-4 flex items-start gap-3">
                ...
                <span>矯正治療で本当にパフォーマンスは向上しますか？</span>
              </h3>
              <div className="pl-9">
                <p className="text-gray-700 leading-loose">
                  <span className="font-bold text-[#5A4D41]">A.</span>
                  はい、<span className="font-bold bg-yellow-100">矯正治療でパフォーマンスが向上する</span>というエビデンスがあります。
                  特に<span className="font-bold text-[#E67A2E]">正しく食いしばれるようになることで、瞬発力が20〜30%向上</span>します。
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-[#E67A2E]/10">
              <h3 className="text-xl font-bold text-[#E67A2E] mb-4 flex items-start gap-3">
                ...
                <span>管楽器を吹きながら矯正治療はできますか？</span>
              </h3>
              <div className="pl-9">
                <p className="text-gray-700 leading-loose mb-3">
                  <span className="font-bold text-[#5A4D41]">A.</span>
                  はい、可能です。ただし、<span className="font-bold bg-yellow-100">矯正装置に慣れるまでの1〜3ヶ月は演奏が難しくなります</span>。
                  特にトランペット・ホルンなど、唇を密着させる楽器は影響が大きいです。
                </p>
                <p className="text-gray-700 leading-loose pl-9">
                  対策として、<span className="font-bold text-[#E67A2E]">取り外し式の装置（プレオルソ）を選ぶ</span>か、
                  <span className="font-bold text-[#E67A2E]">発表会・コンクールの3ヶ月以上前に治療を開始</span>することをおすすめします。
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12">
            ...
            <p className="text-white/90 text-lg mb-8 leading-relaxed">
              F歯科・矯正歯科では、お子さんの習い事に合わせた<br className="md:hidden" />
