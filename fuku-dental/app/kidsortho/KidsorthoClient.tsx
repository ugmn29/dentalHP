...
export default function KidsOrthoPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: (
                <>
                    こども矯正の費用は<span className="border-b-2 border-[#FFD700]">¥132,000〜¥880,000</span>です。詳しくは料金表をご覧ください。<span className="border-b-2 border-[#FFD700]">デンタルローンもご利用いただけます</span>。
                </>
            )
        },
        {
