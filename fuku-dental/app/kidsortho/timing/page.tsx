...
export const metadata: Metadata = {
  title: '小児矯正を始める時期｜何歳から？ベストタイミング｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '小児矯正を始めるベストなタイミングを歯科医師が解説。何歳から始めるべきか、早期治療のメリット、矯正が必要なサインの見分け方をご紹介。豊洲のFデンタルオフィス 豊洲プライムスクエア院で無料相談実施中。',
  keywords: '小児矯正 いつから,子供 矯正 何歳,小児矯正 タイミング,矯正 始める時期,早期矯正 メリット,豊洲 小児矯正',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/timing',
  },
  openGraph: {
    title: '小児矯正を始める時期｜何歳から？ベストタイミング｜Fデンタルオフィス 豊洲プライムスクエア院',
                ...
                <section className="py-6 md:py-6 bg-[#FDFBF7]">
                    <div className="container mx-auto px-4">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <PageImage path="/kidsortho/timing" imageId="歯の生え変わりと治療開始ベストタイミング" alt="小児矯正のベストタイミング" className="mx-auto mb-8 aspect-[16/9] w-full kidsortho-hero-image-card rounded-3xl border border-[#E6E0D6] bg-white object-contain p-3 shadow-lg" />
