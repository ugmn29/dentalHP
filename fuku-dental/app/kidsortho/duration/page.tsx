...
export const metadata: Metadata = {
  ...
  description: '小児矯正の治療期間を歯科医師が解説。1期治療・2期治療それぞれの目安期間、治療期間を左右する要因、通院頻度について。豊洲のFデンタルオフィス 豊洲プライムスクエア院で計画的な矯正治療を行います。',
  keywords: '小児矯正 期間,子供 矯正 いつまで,小児矯正 何年,矯正 通院頻度,1期治療 期間,豊洲 小児矯正',
  alternates: {
    canonical: 'https://fshika.com/kidsortho/duration',
  },
  openGraph: {
    title: '小児矯正の治療期間｜いつまでかかる？｜Fデンタルオフィス 豊洲プライムスクエア院',
                ...
                <div className="bg-[#FDFBF7] border-b">
                    <div className="container mx-auto px-4 py-3">
                        <div className="flex items-center text-sm text-[#8D8070]">
                            ...
                            <ChevronRight className="w-4 h-4 mx-2" />
                            <span className="text-[#C5A572] font-bold">治療期間</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container mx-auto px-4 max-w-4xl">
                        <div className="text-center mb-20">
                            ...
                            <div className="space-y-4 text-[#5A4D41] leading-loose max-w-3xl mx-auto">
                                <p>
                                    小児矯正の<span className="font-bold bg-yellow-100">標準的な治療期間は1〜3年</span>です。
                                    期間が長く感じるのは、<span className="font-bold bg-yellow-100">成長を待つ観察期間</span>が含まれるためです。
                                </p>
                                <p>
                                    約60%のお子さまは<span className="font-bold text-[#C5A572]">1期治療のみで完了</span>し、
                                    積極的治療6〜24ヶ月+保定期間6〜12ヶ月で終了します。
                                </p>
                                <p>
                                    残り40%は2期治療が必要ですが、
                                    <span className="font-bold bg-yellow-100">1期治療を行うことで2期治療の期間を40%短縮</span>できます（24ヶ月 vs. 40ヶ月）。
                                </p>
                                <p>
                                    治療期間を短くするには、
                                    <span className="font-bold bg-yellow-100">3〜7歳の早期開始・装着時間の厳守・定期通院</span>が重要です。
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-6 md:py-6 bg-[#FDFBF7]">
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="mb-12">
                                <div className="mb-6">
                                    <h3 className="text-2xl font-bold text-[#5A4D41] font-serif mb-2 pb-2 border-b-2 border-[#C5A572]">
                                        1期治療の標準期間：1〜3年
                                    </h3>
                                    <div className="mt-4">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <h4 className="font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">
                                            積極的治療期間：6〜24ヶ月
                                        </h4>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                                    <h4 className="font-bold text-[#C5A572] font-serif mb-3">短い場合（6〜9ヶ月）</h4>
                                    <ul className="text-sm text-[#8D8070] space-y-2">
                                        <li className="flex items-start gap-2">
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-[#395b45]">
                                    <h4 className="font-bold text-[#395b45] font-serif mb-3">標準的（1〜1.5年）</h4>
                                    <ul className="text-sm text-[#8D8070] space-y-2">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#395b45]">✓</span>
                                            <span>中等度の不正咬合</span>
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                                    <h4 className="font-bold text-[#C5A572] font-serif mb-3">長い場合（1.5〜2年）</h4>
                                    <ul className="text-sm text-[#8D8070] space-y-2">
                                        <li className="flex items-start gap-2">
                        ...
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="mb-12">
                                ...
                                <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <h4 className="font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">1期治療を行った場合</h4>
                                    ...
                                    <div>
                                        <h4 className="font-bold text-red-700 font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">1期治療を行わなかった場合</h4>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">1. 開始年齢</h3>
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">2. 不正咬合の重症度</h3>
                                    <div className="flex-1 mt-4">
                                        <div className="grid md:grid-cols-3 gap-4">
                                            ...
                                            <div className="bg-[#FFF9F0] rounded-xl p-4">
                                                <p className="font-bold text-[#C5A572] mb-2">中等度</p>
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">3. 装着時間の遵守</h3>
                                    <div className="flex-1 mt-4">
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div className="bg-green-50 rounded-xl p-4 border border-green-200">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">4. 定期通院の遵守</h3>
                                    <div className="flex-1 mt-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-[#5A4D41] font-serif mb-3 pb-2 border-b-2 border-[#C5A572]">5. 悪習癖の有無</h3>
                                    <div className="flex-1 mt-4">
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">治療期間を短くする方法はありますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> 以下の3点を守ることで、計画通りの期間で完了できます：
                                        </p>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">1期治療だけで終わる確率はどのくらいですか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> 約60%のお子さまは1期治療のみで治療が完了します。特に、6〜9歳で治療を開始し、装着時間を守った場合は、2期治療が不要になる確率が高まります。
                                        </p>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">2期治療はいつから始めますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> 永久歯が生え揃う12〜14歳頃から開始します。1期治療終了後、1〜2年の観察期間を設け、永久歯の萌出状況を確認してから2期治療の必要性を判断します。
                                        </p>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">治療期間中、通院頻度はどのくらいですか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> 治療段階によって通院頻度が異なります：
                                        </p>
                                        <ul className="space-y-2 mb-3 ml-4">
                                            <li className="flex items-start gap-2">
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">装置をつけたまま部活やスポーツはできますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> はい、ほとんどの部活動やスポーツは問題なく行えます。
                                        </p>
                                        <ul className="space-y-2 mb-3 ml-4">
                                            <li className="flex items-start gap-2">
                                                <span className="text-[#395b45] mt-1">✓</span>
                                ...
                                <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
                                    <div className="mb-4">
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <h3 className="font-bold text-[#5A4D41] font-serif text-lg">保定期間を守らないとどうなりますか？</h3>
                                        </div>
                                    </div>
                                    <div className="text-[#8D8070] leading-relaxed">
                                        <p className="mb-3">
                                            <strong className="text-[#C5A572]">A.</strong> 保定装置を使用しないと、せっかく整えた歯並びが元に戻ってしまいます（後戻り）。
                                        </p>
                                        <ul className="space-y-2 mb-3 ml-4">
                                            <li className="flex items-start gap-2">
