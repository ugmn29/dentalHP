...
export const metadata: Metadata = {
  ...
  description: "豊洲で歯医者・歯科をお探しの方へ。虫歯・歯周病・定期検診・クリーニング・急な歯の痛みなど、お口のお悩みをご相談ください。Fデンタルオフィス 豊洲プライムスクエア院は、豊洲駅6a出口から徒歩2分、豊洲プライムスクエア1階の歯科医院です。",
  keywords: "豊洲 歯科,豊洲 歯医者,歯科 豊洲,歯医者 豊洲,豊洲 矯正歯科,矯正歯科 豊洲,豊洲駅 歯科,豊洲駅 歯医者,豊洲プライムスクエア,こども矯正,インプラント,セラミック,ホワイトニング,江東区 歯科",
  openGraph: {
    title: "豊洲駅徒歩2分の歯科・歯医者｜Fデンタルオフィス 豊洲プライムスクエア院",
    description: "豊洲で歯医者・歯科をお探しの方へ。虫歯・歯周病・定期検診・クリーニング・急な歯の痛みなど、お口のお悩みをご相談ください。",
