...
export const metadata: Metadata = {
  title: '豊洲のマウスピース矯正｜透明で目立たない歯列矯正｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院でマウスピース矯正。透明で目立たず、取り外し可能な矯正装置で快適に歯並びを改善。食事や歯磨きもストレスフリー。無料相談・シミュレーション実施中。',
