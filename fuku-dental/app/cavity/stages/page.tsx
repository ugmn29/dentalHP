...
export const metadata: Metadata = {
  title: '虫歯の進行段階（C0〜C4）｜虫歯治療｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が虫歯の進行段階をC0からC4まで詳しく解説。各段階での症状、痛みの程度、治療法について分かりやすくご説明します。',
  keywords: '虫歯,C0,C1,C2,C3,C4,進行段階,痛み,症状,虫歯治療,豊洲,歯医者',
  alternates: {
    canonical: 'https://fshika.com/cavity/stages',
  },
  openGraph: {
    title: '虫歯の進行段階（C0〜C4）｜虫歯治療｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が虫歯の進行段階をC0からC4まで詳しく解説。各段階での症状、痛みの程度、治療法について分かりやすくご説明します。',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-[#8D8070] leading-relaxed">
                豊洲駅すぐのFデンタルオフィス 豊洲プライムスクエア院が解説｜虫歯は進行段階によって症状や治療法が大きく異なります
              </p>
            </div>
          </div>
        </section>
