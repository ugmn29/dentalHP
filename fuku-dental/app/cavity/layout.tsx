...
export const metadata: Metadata = {
  title: '虫歯治療なら豊洲駅2分のFデンタルオフィス｜痛みの少ない治療｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィスで虫歯治療。痛みの少ないレーザー治療やマイクロスコープを活用した精密治療で、できるだけ歯を残す治療を行います。保険診療から審美的な自費治療まで対応。まずはお気軽にご相談ください。',
