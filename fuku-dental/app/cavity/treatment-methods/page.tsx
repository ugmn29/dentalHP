...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が虫歯の進行度に応じた治療方法を詳しく解説。コンポジットレジン、インレー、クラウン、根管治療など、それぞれの特徴、メリット・デメリット、費用について。',
  keywords: '虫歯治療,コンポジットレジン,インレー,クラウン,根管治療,詰め物,被せ物,保険治療,自費治療,豊洲,歯医者',
  alternates: {
    canonical: 'https://fshika.com/cavity/treatment-methods',
  },
  openGraph: {
    title: '虫歯の治療方法 | コンポジットレジン・インレー・クラウン・根管治療 | Fデンタルオフィス 豊洲プライムスクエア院',
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-[#5A4D41] leading-relaxed">
                ...
                <span className="text-base text-[#8D8070] mt-2 inline-block">豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院が解説｜コンポジットレジン・インレー・クラウン・根管治療</span>
              </p>
            </div>
          </div>
        </section>
                        ...
                        <div className="bg-[#FFF9F0] p-5 rounded-xl border border-[#C5A572]/30">
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-[#8D8070] mt-1">費用目安：132,000円（税込）</p>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <RelatedPagesSection
          ...
          currentPath="/cavity/treatment-methods"
        />
