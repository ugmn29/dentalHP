...
export const metadata: Metadata = {
  title: '豊洲の審美歯科・セラミック治療｜白く美しい歯に｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院で審美歯科・セラミック治療。銀歯を白いセラミックに交換、オールセラミッククラウン・ジルコニア・e-maxなど豊富な素材から最適な治療をご提案。自然で美しい仕上がりを実現します。',
