...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院がセラミックと銀歯の違いを徹底比較。見た目、寿命、費用、健康面など、あらゆる角度から解説します。あなたに最適な選択肢が見つかります。',
  keywords: 'セラミック,銀歯,比較,違い,どっち,メリット,デメリット,保険,自費',
  alternates: {
    canonical: 'https://fshika.com/ceramic/vs-metal',
  },
  openGraph: {
    title: 'セラミック vs 銀歯｜どっちがいい？徹底比較｜Fデンタルオフィス 豊洲プライムスクエア院',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-[#8D8070] leading-relaxed">
                豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院が見た目・寿命・費用・健康面など、<br />
                あらゆる角度から比較します
              </p>
            </div>
          </div>
