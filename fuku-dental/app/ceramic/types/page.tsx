...
export const metadata: Metadata = {
  title: 'セラミック治療の種類｜インレー・クラウン・ベニア比較｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院がセラミック治療の種類を解説。インレー、アンレー、クラウン、ベニアなど、それぞれの特徴と適応症例を詳しくご紹介。あなたに最適なセラミック治療が見つかります。',
  keywords: 'セラミック,インレー,クラウン,ベニア,アンレー,歯科治療,審美歯科',
  alternates: {
    canonical: 'https://fshika.com/ceramic/types',
  },
  openGraph: {
    title: 'セラミック治療の種類｜インレー・クラウン・ベニア比較｜Fデンタルオフィス 豊洲プライムスクエア院',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-[#8D8070] leading-relaxed">
                豊洲駅すぐのFデンタルオフィス 豊洲プライムスクエア院がそれぞれの特徴を解説。<br />
                あなたに最適な治療法を見つけましょう
              </p>
            </div>
          </div>
