...
export const metadata: Metadata = {
  title: 'セラミック治療の寿命・耐久性｜何年持つ？長持ちさせる方法｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院がセラミック治療の寿命を解説。インレー、クラウン、ベニアの寿命と、長持ちさせるためのケア方法を詳しくご紹介します。',
  keywords: 'セラミック,寿命,耐久性,何年,持つ,長持ち,ケア方法,メンテナンス',
  alternates: {
    canonical: 'https://fshika.com/ceramic/longevity',
  },
  openGraph: {
    title: 'セラミック治療の寿命・耐久性｜何年持つ？長持ちさせる方法｜Fデンタルオフィス 豊洲プライムスクエア院',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-[#8D8070] leading-relaxed">
                豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院が解説｜適切なケアで10年以上使い続けることも可能です
              </p>
            </div>
          </div>
        </section>
