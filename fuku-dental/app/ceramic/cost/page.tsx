...
export const metadata: Metadata = {
  title: 'セラミック治療の費用・値段｜相場と当院の料金表｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院がセラミック治療の費用について詳しく解説。インレー、クラウン、ベニアの料金相場と当院の価格、保険適用、分割払いの情報をご紹介します。',
