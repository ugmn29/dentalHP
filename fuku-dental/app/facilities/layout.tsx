...
export const metadata: Metadata = {
  ...
  description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院の院内設備をご紹介。歯科用CT・マイクロスコープ・口腔内スキャナー・プライバシーに配慮した診療室など、最新の歯科機器を完備。安全で精密な治療環境を整えています。',
  keywords: '豊洲 歯医者 設備,歯科CT,マイクロスコープ 歯科,口腔内スキャナー,個室 診療室,豊洲',
  openGraph: {
    title: '院内設備・設備紹介｜最新の歯科機器完備｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院の院内設備をご紹介。歯科用CT・マイクロスコープ・口腔内スキャナー・プライバシーに配慮した診療室など、最新の歯科機器を完備。安全で精密な治療環境を整えています。',
    type: 'website',
