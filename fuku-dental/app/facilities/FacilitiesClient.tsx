...
export default function FacilitiesPage() {
  const facilities = [
    ...
    },
    {
      ...
      title: "お子様連れにも配慮した",
      highlight: "診療環境",
      summary: "親子で通いやすい院内づくり",
      details: [
        "小さなお子様連れの方にも通いやすいよう、動線やご案内に配慮しています。",
        "親子でのご来院時も、できるだけスムーズに診療へ進めるようスタッフがサポートします。",
        "保護者の方も安心してご相談いただける環境づくりを心がけています。"
      ],
      imageId: "facility4",
      imageAlt: "お子様連れにも配慮した診療環境"
    },
    {
      id: "05",
      title: "衛生管理を徹底した",
