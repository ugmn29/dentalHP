...
export const metadata: Metadata = {
  title: '口臭治療・口臭の原因と対策｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '口臭でお悩みの方へ。豊洲のFデンタルオフィス 豊洲プライムスクエア院で口臭の原因を検査・特定し、適切な治療を行います。歯周病・虫歯・舌苔など口臭の原因別に対策をご提案。デリケートなお悩みも安心してご相談ください。',
