...
export const metadata: Metadata = {
  title: '歯医者嫌いを克服｜お子様が安心して通える工夫｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: 'お子様の歯医者嫌い・歯科恐怖症を克服するためのFデンタルオフィス 豊洲プライムスクエア院の取り組み。Tell-Show-Do法やアニメーション、ご褒美など、お子様が笑顔で通える工夫をご紹介。豊洲駅徒歩2分。',
