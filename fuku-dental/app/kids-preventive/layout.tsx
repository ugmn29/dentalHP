...
export const metadata: Metadata = {
  title: '豊洲の小児歯科・子供の予防歯科｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院で小児歯科。お子様の虫歯予防・フッ素塗布・シーラント・歯磨き指導を行います。歯医者が苦手なお子様も安心して通えるよう、やさしく丁寧な対応を心がけています。',
