...
export default function PeriodontalPage() {
    ...
    const heroImages = [
        { src: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=2000", alt: "歯周病治療1" },
        { src: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&q=80&w=2000", alt: "歯周病治療2" },
        { src: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=2000", alt: "歯周病治療3" },
    ];
    ...
    const cases = [
        { title: "50代男性・歯周組織再生療法", desc: "歯茎の腫れと歯のぐらつきが気になり来院されました。", before: "https://placehold.co/400x300/png?text=Before", after: "https://placehold.co/400x300/png?text=After", tags: ["エムドゲイン", "6ヶ月"], price: "要相談" },
        { title: "40代女性・スケーリング+定期管理", desc: "歯磨き時の出血が続き、歯周病の診断を受けました。", before: "https://placehold.co/400x300/png?text=Before", after: "https://placehold.co/400x300/png?text=After", tags: ["基本治療", "3ヶ月"], price: "保険適用" },
        { title: "60代男性・フラップ手術", desc: "重度の歯周病で、歯を残すための外科治療を行いました。", before: "https://placehold.co/400x300/png?text=Before", after: "https://placehold.co/400x300/png?text=After", tags: ["外科治療", "1年"], price: "要相談" }
    ];
                ...
                <section className="pt-8 pb-8 bg-white overflow-hidden">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="space-y-12 max-w-5xl mx-auto">
                            {[
                                { id: "01", title: "Visual Explanation", highlight: "口腔内カメラでよりわかりやすく", summary: "<span class='font-bold bg-yellow-100'>口腔内カメラ</span>でお口の中を撮影し、<span class='font-bold bg-yellow-100'>モニターに映しながら現状をご説明</span>します。磨き残しや歯周病の進行具合を<span class='text-[#395b45] font-bold'>目で見て確認できる</span>ため、納得して治療を受けていただけます。", details: [], image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=800" },
                                { id: "02", title: "Plaque Visualization", highlight: "染め出しでより見やすく", summary: "<span class='font-bold bg-yellow-100'>染め出し液</span>を使って、普段磨けていない箇所を赤く着色します。<span class='text-[#395b45] font-bold'>どこに磨き残しがあるのかが一目でわかる</span>ため、効果的なブラッシング改善につながります。", details: [], image: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&q=80&w=800" },
                                { id: "03", title: "Individual Guidance", highlight: "個別のブラッシング指導", summary: "患者様ごとにお口の状態や磨き残しの癖は異なります。当院では、<span class='font-bold bg-yellow-100'>歯科衛生士がお一人おひとりに最適な磨き方や歯ブラシの選び方を丁寧に指導</span>いたします。<span class='text-[#395b45] font-bold'>継続的なサポートで習慣化を促進</span>します。", details: [], image: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=800" },
                                { id: "04", title: "Lifestyle Approach", highlight: "生活習慣からのアプローチ", summary: "<span class='font-bold bg-yellow-100'>喫煙・ストレス・食生活</span>など、歯周病に影響する生活習慣もヒアリング。お口の中だけでなく、<span class='text-[#395b45] font-bold'>根本的な原因にアプローチし、全身の健康を考えた総合的なサポート</span>を行います。", details: [], image: "https://images.unsplash.com/photo-1584036561566-b93a945c3cbc?auto=format&fit=crop&q=80&w=800" },
