...
export const metadata: Metadata = {
  title: 'インプラント治療の流れ｜8つのステップで安心治療 | Fデンタルオフィス 豊洲プライムスクエア院',
  description:
    'インプラント治療の流れを8つのステップで詳しく解説。無料カウンセリングから精密検査、手術、人工歯装着、メンテナンスまで、安心・安全な治療プロセスをご紹介します。Fデンタルオフィス 豊洲プライムスクエア院。',
  keywords:
    'インプラント,治療の流れ,手術の流れ,インプラント手術,治療期間,治療プロセス,歯科インプラント,CT検査,骨結合,アバットメント,人工歯,メンテナンス',
  alternates: {
    canonical: 'https://fshika.com/implant/flow',
  },
  openGraph: {
    title: 'インプラント治療の流れ｜8つのステップで安心治療 | Fデンタルオフィス 豊洲プライムスクエア院',
