...
export const metadata: Metadata = {
  title: 'インプラント症例ギャラリー｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院のインプラント治療症例ギャラリー。実際の治療結果をご覧いただけます。豊富な症例実績で安心のインプラント治療を提供しています。',
  keywords: 'インプラント 症例,インプラント ギャラリー,インプラント ビフォーアフター,豊洲 インプラント 実績',
  alternates: {
    canonical: 'https://fshika.com/implant/gallery',
  },
  openGraph: {
    title: 'インプラント症例ギャラリー｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院のインプラント治療症例ギャラリー。実際の治療結果をご覧いただけます。',
    type: 'website',
    locale: 'ja_JP',
