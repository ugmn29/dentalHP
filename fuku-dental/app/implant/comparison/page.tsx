...
export const metadata: Metadata = {
  title: 'インプラント・入れ歯・ブリッジの違いを徹底比較｜Fデンタルオフィス 豊洲プライムスクエア院',
  description:
  ...
  alternates: {
    canonical: 'https://fshika.com/implant/comparison',
  },
  openGraph: {
    title: 'インプラント・入れ歯・ブリッジの違いを徹底比較｜Fデンタルオフィス 豊洲プライムスクエア院',
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-red-100">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    {
                      title: '費用が高い',
                      desc: '自費診療のため、簡単なケースで¥495,000、難症例で¥595,000の費用がかかります。ただし医療費控除の対象です。',
                    },
                    {
                      title: '治療期間が長い',
        ...
        <section className="py-16 px-4 bg-white" style={{ fontFamily: 'YuGothic, "Yu Gothic", sans-serif' }}>
          <div className="max-w-4xl mx-auto">
            ...
            <RelatedPagesSection
              ...
              currentPath="/implant/comparison"
