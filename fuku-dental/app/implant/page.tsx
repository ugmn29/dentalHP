...
export const metadata: Metadata = {
  ...
  description: '豊洲駅徒歩2分、Fデンタルオフィス 豊洲プライムスクエア院のインプラント治療。500症例以上の経験を持つ院長が、歯科用CTと綿密な計画で安全なインプラント治療を提供。プライバシーに配慮した診療環境で静脈内鎮静法にも対応。無料相談実施中。',
  keywords: '豊洲,歯医者,インプラント,歯科,デンタルクリニック,インプラント治療,CT診断,静脈内鎮静法,無料相談,豊洲駅,江東区,豊洲 歯医者,豊洲 インプラント,豊洲 歯科',
  openGraph: {
    title: '豊洲のインプラント治療｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲駅徒歩2分。500症例以上の経験を持つ院長が、歯科用CTと綿密な計画で安全なインプラント治療を提供。プライバシーに配慮した診療環境・静脈内鎮静法対応。無料相談実施中。',
    type: 'website',
    locale: 'ja_JP',
