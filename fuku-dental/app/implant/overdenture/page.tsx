...
export const metadata: Metadata = {
  title: 'インプラントオーバーデンチャー｜入れ歯の悩みを解決｜Fデンタルオフィス 豊洲プライムスクエア院',
  ...
  alternates: {
    canonical: 'https://fshika.com/implant/overdenture',
  },
  openGraph: {
    title: 'インプラントオーバーデンチャー｜入れ歯の悩みを解決｜Fデンタルオフィス 豊洲プライムスクエア院',
    ...
    type: 'website',
    locale: 'ja_JP',
    url: 'https://fshika.com/implant/overdenture',
        ...
        <section className="pt-8 pb-2 bg-[#FDFBF7]">
          <div className="container mx-auto px-4 max-w-5xl" style={{ fontFamily: 'YuGothic, "Yu Gothic", sans-serif' }}>
            ...
            <RelatedPagesSection
              ...
              currentPath="/implant/overdenture"
