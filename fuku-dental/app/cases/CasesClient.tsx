  ...
  const caseStudies = [
    {
      id: 1,
      title: "前歯の隙間改善",
      beforeImageId: "case1-before",
      afterImageId: "case1-after",
    ...
    },
    {
      id: 2,
      title: "銀歯をセラミックに",
      beforeImageId: "case2-before",
      afterImageId: "case2-after",
    ...
    },
    {
      id: 3,
      title: "ホワイトニング",
      beforeImageId: "case3-before",
      afterImageId: "case3-after",
    ...
    },
    {
      id: 4,
      title: "インプラント治療",
      beforeImageId: "case4-before",
      afterImageId: "case4-after",
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      <PageImage
                        path="/cases"
                        imageId={caseStudy.beforeImageId}
                    ...
                    <div className="relative">
                      ...
                      <PageImage
                        path="/cases"
                        imageId={caseStudy.afterImageId}
