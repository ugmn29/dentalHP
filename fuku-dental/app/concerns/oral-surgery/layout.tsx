...
export const metadata: Metadata = {
  title: '豊洲の口腔外科｜親知らず・顎関節症・外傷｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院で口腔外科治療。親知らずの抜歯・顎関節症・口内のできもの・外傷など幅広く対応。歯科用CTによる精密診断で安全な治療を提供します。',
