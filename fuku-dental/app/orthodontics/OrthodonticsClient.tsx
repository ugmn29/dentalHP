                ...
                <section className="relative w-full overflow-hidden bg-white">
                    <div className="relative w-full" style={{ height: '50vh' }}>
                        {heroImages.map((image, index) => (
                            ...
                            >
                                <PageImage path="/orthodontics" imageId={image.imageId} alt={image.alt} className="w-full h-full object-cover" />
                            ...
                            {[
                                ...
                                <div key={index} className="group cursor-pointer">
                                    <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
                                        <PageImage path="/orthodontics" imageId={item.imageId} alt={item.title} className="w-full h-64 object-cover transform group-hover:scale-110 transition-transform duration-700" />
                                ...
                                <div key={feature.id} className="flex flex-col group">
                                    ...
                                    <div className="w-full mb-8 relative">
                                        <div className="relative rounded-[30px] overflow-hidden shadow-lg border-2 border-white">
                                            <PageImage path="/orthodontics" imageId={feature.imageId} alt={feature.highlight} className="w-full h-auto aspect-[16/9] object-cover" />
