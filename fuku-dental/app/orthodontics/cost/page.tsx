...
export const metadata: Metadata = {
  title: '矯正治療の費用・料金｜分割払い・デンタルローン対応｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が矯正治療の費用を詳しく解説。ワイヤー矯正70万円〜、マウスピース矯正80万円〜、裏側矯正120万円〜。分割払い・デンタルローン・医療費控除にも対応。明確な料金体系で安心です。',
  keywords: '矯正,費用,料金,値段,安い,分割払い,デンタルローン,医療費控除,支払い方法,Fデンタルオフィス 豊洲プライムスクエア院',
  openGraph: {
    title: '矯正治療の費用・料金｜分割払い・デンタルローン対応｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が矯正治療の費用を詳しく解説。ワイヤー矯正70万円〜、マウスピース矯正80万円〜。分割払い・医療費控除にも対応。',
    type: 'website',
    locale: 'ja_JP',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-amber-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院は明確な料金体系で安心。分割払い・デンタルローンにも対応しています
              </p>
            </div>
          </div>
