...
export const metadata: Metadata = {
  title: '矯正治療の症例紹介｜治療実績と患者様の声｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院の矯正治療症例を詳しくご紹介。出っ歯・受け口・ガタガタ・すきっ歯など、様々な症例の治療結果をビフォーアフターでご覧いただけます。',
  keywords: '矯正,症例,治療例,ビフォーアフター,患者様の声,実績,成功率,出っ歯,受け口,ガタガタ,Fデンタルオフィス 豊洲プライムスクエア院',
  alternates: {
    canonical: 'https://fshika.com/orthodontics/case-studies',
  },
  openGraph: {
    title: '矯正治療の症例紹介｜治療実績と患者様の声｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院の矯正治療症例をご紹介。出っ歯・受け口・ガタガタ・すきっ歯など、様々な症例の治療結果を掲載。',
    type: 'website',
    locale: 'ja_JP',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-amber-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院による実際の治療例から、矯正治療の効果と患者様の満足度をご確認ください
              </p>
            </div>
          </div>
