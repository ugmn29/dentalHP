...
export const metadata: Metadata = {
  ...
  description: '豊洲駅6a出口から徒歩2分、豊洲プライムスクエア1階の歯医者。Fデンタルオフィス 豊洲プライムスクエア院は、0歳からの小児歯科・こども矯正、予防歯科、セラミック、インプラント、マウスピース矯正まで幅広く対応します。豊洲で歯科をお探しの方へ、丁寧な説明と精密診断を大切にしています。',
