...
import { Phone, Calendar, Smile, Sparkles, ChevronRight, Shield, Baby, Gem, Wind, Search, Activity, Layers, Scissors, AlertCircle, Zap, Stethoscope, ShieldCheck, ArrowDownToLine, Moon } from 'lucide-react';
...
export default function Home() {
  ...
  // Hero slider images
  const heroImages = [
    { src: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=2000", alt: "F歯科・こども歯科・矯正 院内写真1" },
    { src: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=2000", alt: "F歯科・こども歯科・矯正 院内写真2" },
    { src: "https://images.unsplash.com/photo-1504813184591-01572f98c85f?auto=format&fit=crop&q=80&w=2000", alt: "F歯科・こども歯科・矯正 院内写真3" },
  ];
  ...
  const facilityImages = [
    { src: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=2000", title: "リラックスできる広々とした待合室" },
    { src: "https://images.unsplash.com/photo-1504813184591-01572f98c85f?auto=format&fit=crop&q=80&w=2000", title: "プライバシーに配慮した診療室" },
    { src: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=2000", title: "正確な診断を可能にする歯科用CT" },
    { src: "https://images.unsplash.com/photo-1596495578065-6e0763fa1178?auto=format&fit=crop&q=80&w=2000", title: "お子様も退屈しないキッズスペース" },
  ];
  ...
  const featureHighlights = [
    {
      ...
      image: "https://images.unsplash.com/photo-1596464716127-f9a87595ca58?auto=format&fit=crop&q=80&w=800",
              ...
              {featureHighlights.map((feature, index) => (
                ...
                >
                  ...
                  <div className="hidden lg:block lg:w-1/2 relative">
                    <div className="relative rounded-[40px] overflow-hidden shadow-2xl transform group-hover:scale-[1.02] transition-transform duration-700 ease-out">
                      <img
                        src={feature.image}
