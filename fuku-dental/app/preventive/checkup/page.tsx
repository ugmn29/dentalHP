...
export const metadata: Metadata = {
  title: '定期検診｜虫歯・歯周病の早期発見で歯を守る｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院の定期検診で虫歯や歯周病を早期発見・早期治療。痛みが出る前に対処し、治療も最小限に。80歳まで自分の歯を残すために定期検診が重要です。',
  keywords: '定期検診,歯科検診,虫歯予防,歯周病予防,早期発見,予防歯科',
  alternates: {
    canonical: 'https://fshika.com/preventive/checkup',
  },
  openGraph: {
    title: '定期検診｜虫歯・歯周病の早期発見で歯を守る｜Fデンタルオフィス 豊洲プライムスクエア院',
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-[#FDFBF7]">
        ...
        <RelatedPagesSection
          ...
          currentPath="/preventive/checkup"
        />
