...
export const metadata: Metadata = {
  title: '予防歯科の費用｜予防歯科｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院の予防歯科費用をご案内。予防歯科の多くは保険診療で対応可能です。定期検診、クリーニング、フッ素塗布など、各予防処置ごとの費用目安と医療費控除について詳しくご紹介します。',
  keywords: '予防歯科,費用,保険診療,料金,医療費控除,定期検診,クリーニング,フッ素塗布,豊洲,歯医者',
  alternates: {
    canonical: 'https://fshika.com/preventive/cost',
  },
  openGraph: {
    title: '予防歯科の費用｜予防歯科｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院の予防歯科費用をご案内。予防歯科の多くは保険診療で対応可能です。定期検診、クリーニング、フッ素塗布など、各予防処置ごとの費用目安と医療費控除について詳しくご紹介します。',
