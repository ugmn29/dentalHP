...
export const metadata: Metadata = {
  title: 'フッ素塗布｜予防歯科｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院のフッ素塗布は虫歯予防に効果的な予防処置です。歯質の強化、再石灰化の促進、虫歯菌の抑制など、フッ素塗布のメリットと効果について詳しくご紹介します。',
  keywords: 'フッ素塗布,虫歯予防,歯質強化,再石灰化,子ども,大人,フッ素,予防歯科,豊洲,歯医者',
  alternates: {
    canonical: 'https://fshika.com/preventive/fluoride',
  },
  openGraph: {
    title: 'フッ素塗布｜予防歯科｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院のフッ素塗布は虫歯予防に効果的な予防処置です。歯質の強化、再石灰化の促進、虫歯菌の抑制など、フッ素塗布のメリットと効果について詳しくご紹介します。',
