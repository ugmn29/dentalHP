...
export const metadata: Metadata = {
  title: '豊洲の予防歯科｜定期検診・クリーニング｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院で予防歯科。定期検診・歯のクリーニング・フッ素塗布で虫歯や歯周病を未然に防ぎます。プロによる歯石除去とブラッシング指導で、お口の健康を長く守ります。',
