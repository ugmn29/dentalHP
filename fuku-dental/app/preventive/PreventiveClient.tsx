                    ...
                    <div className="relative w-full" style={{ height: '50vh' }}>
                        {heroImages.map((image, index) => (
                            <div key={index} className={`absolute inset-0 transition-opacity duration-1000 ${index === currentHeroSlide ? 'opacity-100' : 'opacity-0'}`}>
                                <PageImage path="/preventive" imageId={image.imageId} alt={image.alt} className="w-full h-full object-cover" />
                ...
                <section className="pt-8 pb-8 bg-white">
                    <div className="container mx-auto px-4 max-w-6xl">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                { title: "Case.01", desc: "定期検診で初期虫歯を発見し、早期に対処できました。", imageId: "case1" },
                                { title: "Case.02", desc: "PMTC後、歯の表面がツルツルになり着色も除去されました。", imageId: "case2" },
                                { title: "Case.03", desc: "歯周病の予防ケアで、歯茎の健康を維持しています。", imageId: "case3" }
                            ].map((item, index) => (
                                <div key={index} className="group cursor-pointer">
                                    <div className="relative overflow-hidden rounded-2xl mb-6 shadow-lg">
                                        <PageImage path="/preventive" imageId={item.imageId} alt={item.title} className="w-full h-64 object-cover transform group-hover:scale-110 transition-transform duration-700" />
                                ...
                                <div key={feature.id} className="flex flex-col group">
                                    ...
                                    <div className="w-full mb-8 relative">
                                        <div className="relative rounded-[30px] overflow-hidden shadow-lg border-2 border-white">
                                            <PageImage path="/preventive" imageId={feature.imageId} alt={feature.highlight} className="w-full h-auto aspect-[16/9] object-cover" />
                    ...
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-2xl mx-auto">
                            ...
                            <button className="bg-transparent border-2 border-[#C5A572] hover:bg-[#C5A572]/10 text-white px-8 py-5 rounded-full font-bold transition-all flex items-center justify-center gap-3 text-lg flex-1">
                                <Phone className="text-[#C5A572]" />03-6204-2876
                            </button>
                        </div>
                        <div className="mt-12">
