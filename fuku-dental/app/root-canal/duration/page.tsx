...
import { rootCanalRelatedPages } from '@/data/related-pages';

export const metadata: Metadata = {
  title: '根管治療の期間・回数｜治療にかかる期間と通院回数｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が根管治療にかかる期間と通院回数を詳しく解説。初回治療、再根管治療、歯根端切除術それぞれの治療期間、各回の治療内容、期間が長引く原因について説明します。',
  keywords: '根管治療,期間,回数,通院,治療期間,何回,何ヶ月,Fデンタルオフィス 豊洲プライムスクエア院',
  alternates: {
    canonical: 'https://fshika.com/root-canal/duration',
  },
  openGraph: {
    title: '根管治療の期間・回数｜治療にかかる期間と通院回数｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が根管治療にかかる期間と通院回数を詳しく解説。初回治療・再根管治療・歯根端切除術それぞれの治療期間をご紹介。',
    type: 'website',
    locale: 'ja_JP',
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <RelatedPagesSection
          title="根管治療について、さらに詳しく"
          items={rootCanalRelatedPages}
          currentPath="/root-canal/duration"
        />
