...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィスが根管治療の種類を詳しく解説。初回根管治療、再根管治療（リトリートメント）、歯根端切除術など、症状に応じた最適な治療法をご紹介します。',
  keywords: '根管治療,種類,再根管治療,リトリートメント,歯根端切除術,抜髄,感染根管治療,Fデンタルオフィス 豊洲プライムスクエア院',
  openGraph: {
    title: '根管治療の種類｜初回治療・再根管治療・歯根端切除術｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィスが根管治療の種類を詳しく解説。初回根管治療、再根管治療、歯根端切除術など、症状に応じた最適な治療法をご紹介します。',
    type: 'website',
    locale: 'ja_JP',
