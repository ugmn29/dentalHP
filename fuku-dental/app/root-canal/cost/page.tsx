...
export const metadata: Metadata = {
  title: '根管治療の費用・料金｜保険診療と自費診療の違い｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が根管治療の費用を詳しく解説。保険診療は3,000円〜12,000円程度、マイクロスコープを使った精密根管治療は自費で50,000円〜150,000円。費用の違いと治療内容を比較できます。',
  keywords: '根管治療,費用,料金,値段,保険,自費,マイクロスコープ,精密根管治療,Fデンタルオフィス 豊洲プライムスクエア院',
  openGraph: {
    title: '根管治療の費用・料金｜保険診療と自費診療の違い｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院が根管治療の費用を詳しく解説。保険診療3,000円〜、自費精密根管治療50,000円〜。費用の違いと治療内容を比較。',
    type: 'website',
    locale: 'ja_JP',
