...
export const metadata: Metadata = {
  title: '顎関節症の専門治療｜原因から改善まで｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院で顎関節症の専門治療。精密検査で原因を特定し、スプリント療法・理学療法・噛み合わせ治療で根本から改善。顎の痛み・開口障害・関節音でお悩みの方はご相談ください。',
