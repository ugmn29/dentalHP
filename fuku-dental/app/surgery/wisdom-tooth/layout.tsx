...
export const metadata: Metadata = {
  title: '親知らずの抜歯｜痛みの少ない安全な治療｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲のFデンタルオフィス 豊洲プライムスクエア院で親知らずの抜歯。歯科用CTで精密に診断し、痛みの少ない安全な抜歯を行います。横向き・埋伏した難しい親知らずにも対応。抜歯後のケアも丁寧に説明します。',
