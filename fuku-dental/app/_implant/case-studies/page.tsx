...
export const metadata: Metadata = {
  title: 'インプラント治療の症例紹介｜治療実績と患者様の声｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: 'Fデンタルオフィス 豊洲プライムスクエア院のインプラント治療症例を詳しくご紹介。前歯・奥歯・複数本の症例から、治療期間・費用・患者様の満足度まで実際の治療結果をご覧いただけます。',
  keywords: 'インプラント,症例,治療例,ビフォーアフター,患者様の声,実績,成功率,Fデンタルオフィス 豊洲プライムスクエア院',
};
