export default function WhyUs() {
  const pillars = [
    ...
    },
    {
      ...
      ja: 'SNSマーケティング',
      tag: '希望者は関われる',
      lead: '医院としてInstagram・TikTok・YouTubeの企画と運用に取り組んでいます。',
      body: '台本作り・撮影・編集・分析まで、興味のあるスタッフは希望に応じて関われます。強制ではありません。「やってみたい」を大切にしながら、一般的な歯科医院ではなかなか得られないメディア運用の経験を積めるチャンスを用意しています。',
