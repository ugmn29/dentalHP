...
export default function FAQ() {
  ...
  const items = [
    {
      q: '試用期間はありますか？',
      a: '6ヶ月の試用期間があります。試用期間中は賃金が基準額より5,000円減額となりますが、評価手当・インセンティブ等の対象にはなります。'
    },
    {
    ...
    {
      q: '残業は多いですか？',
      a: '平日は19時を目安に、業務が終わり次第退勤です。19時までに片付けまで終わればその時間で帰れますし、長引いても19:15ごろがほとんどです。月30時間分を固定残業代（45,000円）として支給、超過分は別途支給します。'
    },
    {
      q: '有給は取りやすいですか？',
      a: '入社半年後に10日付与（法定通り）。原則2ヶ月前までの申請ですが、2ヶ月を切っても院長への直接申請で対応可能です（精勤手当も支給されます）。'
    },
    {
      q: '妊娠・出産後も働き続けられますか？',
