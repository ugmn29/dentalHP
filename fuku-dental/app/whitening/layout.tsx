...
export const metadata: Metadata = {
  title: '豊洲のホワイトニング｜歯を白く美しく｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲駅徒歩2分のFデンタルオフィス 豊洲プライムスクエア院でホワイトニング。オフィスホワイトニング・ホームホワイトニング・デュアルホワイトニングに対応。安全な薬剤で自然な白さを実現。結婚式やイベント前にもおすすめです。',
