...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィスのホワイトニング料金・費用を詳しく解説。オフィス・ホーム・デュアルホワイトニングの価格相場、当院の料金プラン、費用対効果、保険適用、支払い方法まで完全ガイド。',
  keywords: 'ホワイトニング,料金,費用,値段,価格,相場,オフィスホワイトニング,ホームホワイトニング,デュアルホワイトニング,豊洲,歯医者',
  openGraph: {
    title: 'ホワイトニングの料金・費用｜各プランの価格を徹底解説｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィスのホワイトニング料金を詳しく解説。オフィス・ホーム・デュアルの価格相場と費用対効果を比較。',
    type: 'website',
  },
};
