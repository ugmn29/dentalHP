...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯科 Fデンタルオフィスがホワイトニングの3つの種類（オフィス・ホーム・デュアル）を徹底比較。それぞれのメリット・デメリット、費用、効果持続期間、おすすめの方を詳しく解説します。',
  keywords: 'ホワイトニング,種類,オフィスホワイトニング,ホームホワイトニング,デュアルホワイトニング,比較,違い,豊洲,歯医者',
  openGraph: {
    title: 'ホワイトニングの種類｜オフィス・ホーム・デュアル徹底比較｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィスがホワイトニングの3つの種類を徹底比較。あなたに最適な方法が見つかります。',
    type: 'website',
  },
};
