...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院のホワイトニングが選ばれる理由を徹底解説。他院との違い、当院だけの特徴、充実したサービス内容をご紹介します。',
  keywords: 'ホワイトニング,比較,選び方,おすすめ,歯科医院,違い,特徴,豊洲,歯医者',
  alternates: {
    canonical: 'https://fshika.com/whitening/comparison',
  },
  openGraph: {
    title: '当院のホワイトニングが選ばれる理由｜他院との違い｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院のホワイトニングが選ばれる理由と他院との違いをご紹介します。',
    type: 'website',
  },
};
