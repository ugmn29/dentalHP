...
export const metadata: Metadata = {
  ...
  description: '豊洲の歯医者 Fデンタルオフィスがホワイトニングの安全性を解説。知覚過敏などの副作用やリスクについて詳しくご説明。歯科医師が安全性を最優先に施術する理由と、副作用を最小限に抑える方法をご紹介します。',
  keywords: 'ホワイトニング,安全性,副作用,知覚過敏,リスク,痛い,しみる,危険性,豊洲,歯医者',
  openGraph: {
    title: 'ホワイトニングの安全性・副作用｜知覚過敏などのリスクと対策｜Fデンタルオフィス 豊洲プライムスクエア院',
    description: '豊洲の歯医者 Fデンタルオフィスがホワイトニングの安全性と副作用について詳しく解説します。',
    type: 'website',
  },
};
