...
export const metadata: Metadata = {
  title: 'ホワイトニングの効果持続期間｜白さを長持ちさせる方法｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '豊洲の歯医者 Fデンタルオフィス 豊洲プライムスクエア院がホワイトニングの効果持続期間を解説。オフィス・ホーム・デュアルの持続期間と、白さを長持ちさせるための具体的な方法を徹底解説します。',
  keywords: 'ホワイトニング,持続期間,効果,どれくらい,長持ち,メンテナンス,タッチアップ',
  alternates: {
    canonical: 'https://fshika.com/whitening/duration',
  },
  openGraph: {
    title: 'ホワイトニングの効果持続期間｜白さを長持ちさせる方法｜Fデンタルオフィス 豊洲プライムスクエア院',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-[#8D8070] leading-relaxed">
                豊洲の歯科 Fデンタルオフィス 豊洲プライムスクエア院が、適切なケアで白さを長期間維持する方法をお伝えします
              </p>
            </div>
          </div>
        </section>
