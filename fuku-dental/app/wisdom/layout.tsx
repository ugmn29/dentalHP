...
export const metadata: Metadata = {
  title: '親知らずの基礎知識｜生え方・症状・治療法｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: '親知らずの生え方・症状・治療法を歯科医師が詳しく解説。抜くべきか残すべきか、痛みが出た時の対処法、抜歯の流れや費用について。豊洲のFデンタルオフィス 豊洲プライムスクエア院で安心の親知らず治療を。',
