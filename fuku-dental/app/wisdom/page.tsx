  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <Image
          src="https://images.unsplash.com/photo-1629909615957-be38b83483d7?auto=format&fit=crop&q=80&w=2000"
          alt="親知らずの抜歯"
          fill
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white p-8 md:p-12 rounded-2xl border border-gray-100">
            ...
            <div className="space-y-12">
              {[
                { num: "01", title: "初診・カウンセリング", desc: "現在の症状や不安なことをお聞きし、お口の中を確認します。治療への不安や疑問点など、何でもお話しください。", image: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&q=80&w=800" },
                { num: "02", title: "CT撮影・精密検査", desc: "3次元CT画像で、親知らずの位置、神経や血管との距離、骨の状態を正確に把握します。この情報が安全な抜歯の鍵となります。", image: "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&q=80&w=800" },
                { num: "03", title: "診断・治療計画の説明", desc: "CT画像を見ながら、抜歯の必要性、リスク、術式について詳しく説明します。抜歯しない選択肢も含め、一緒に最適な方法を決めていきます。", image: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&q=80&w=800" },
                { num: "04", title: "抜歯処置", desc: "表面麻酔後、痛みの少ない麻酔を実施。CTで確認した計画に基づき、丁寧かつ迅速に抜歯を行います。処置時間は通常20～40分程度です。", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&q=80&w=800" },
                { num: "05", title: "術後の説明・投薬", desc: "抜歯後の注意事項（うがい、食事、運動など）を詳しく説明し、鎮痛剤と抗生剤を処方します。緊急時の連絡先もお伝えします。", image: "https://images.unsplash.com/photo-1584036561566-b93a945c3cbc?auto=format&fit=crop&q=80&w=800" },
                { num: "06", title: "経過観察・抜糸", desc: "1週間後に来院いただき、傷口の治癒状態を確認し、抜糸を行います（縫合した場合）。問題なければ、これで治療完了です。", image: "https://images.unsplash.com/photo-1629909615184-74f495363b67?auto=format&fit=crop&q=80&w=800" }
              ].map((step, index) => (
                <div key={index}>
