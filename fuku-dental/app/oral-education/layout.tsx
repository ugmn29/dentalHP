...
export const metadata: Metadata = {
  title: 'お口の豆知識・歯科コラム｜Fデンタルオフィス 豊洲プライムスクエア院',
  description: 'Fデンタルオフィス 豊洲プライムスクエア院がお届けする歯と口腔の健康に関する豆知識・コラム。口呼吸のリスク、歯並びが悪くなる原因、お口ぽかんの対策など、日常生活で役立つ歯科情報をわかりやすく解説します。',
