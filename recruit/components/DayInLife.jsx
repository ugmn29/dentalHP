// 1日の流れ（タイムライン）
const DayInLife = () => {
  const [role, setRole] = React.useState('weekday');
  const weekday = [
    ['09:45', '出勤・打刻', '打刻してから着替え、開院準備へ。'],
    ['10:00', '開院 / 午前診療', '担当制でアポを管理。候補を2〜3提示するアポ取りを徹底。'],
    ['13:00', '休憩（60分）', 'スタッフルームで昼食。'],
    ['14:00', '午後診療', 'P1〜SPT、補綴、矯正、インビザ。必要に応じて口腔内写真5枚法。'],
    ['18:45', '片付け', 'スピットン洗浄・オートクレーブ稼働確認・翌日申し送り。'],
    ['19:00', '終業・退勤', '残業は月30時間（固定残業代内）を目安に。超過分は別途支給。'],
  ];
  const weekend = [
    ['08:45', '出勤・打刻', '土日は朝が早いぶん、終業も早め。'],
    ['09:00', '開院 / 午前診療', '土日はご家族連れが多く、キッズ対応も多め。'],
    ['12:00', '休憩（60分）', ''],
    ['13:00', '午後診療', '13:00〜17:00。'],
    ['17:00', '終業・退勤', '平日より2時間早く上がれます。'],
  ];
